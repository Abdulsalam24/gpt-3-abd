    ...
    <nav className="z-10 pb-[50px]">
      <div className="relative w-full px-7 max-w-[1300px] flex justify-between items-center mx-auto py-6 lg:px-4 lg:py-3 lg:gap-4">
        ...
        <div
          className={`absolute ${
            mobile && "hidden"
          } top-0 left-0 h-screen bg-bluish z-10 text-white w-full flex flex-col gap-5 lg:flex lg:justify-between lg:flex-row lg:bg-inherit lg:items-center lg:static lg:h-20 lg:w-[90%]`}
        >
